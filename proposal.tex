...
are not in Unicode. Adding these standardised symbols to Unicode will allow for
their semantic identification and use. For the first time they would be searchable
in plain text, something not possible with embedded graphics, which is the way the
