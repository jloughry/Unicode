...
as well as evidence that the characters have been used in running text.
\end{abstract}
...
\begin{figure}[h!]
	...
	\caption{Example of \IEC{P} in use in text from 2011, in the installation
...
\begin{figure}[h!]
	...
	\caption{Example of \IEC{P} in use in text from 2007, in the user's guide
		for a computer. From \cite[Chapter 1, p.~12]{Apple2007} (permission
		applied for).}
...
\begin{figure}[h!]
	...
	\caption{Example of \IEC{P} in use in text from 2009, in the setup guide
		for a printer. From \cite[p.~2]{HP2009} (permission applied for).}
	\label{figure:example-of-use-HP} % label must come after caption
\end{figure}

\begin{figure}[h!]
	\includegraphics[width=\textwidth]{graphics/IEEE1621.png}
	\caption{Example of \IEC{1}, \IEC{S}, and \IEC{0} in use in text from 2004,
		in a standards document. From \cite[\S 4.5.2, p.~7]{IEEE1621} (permission
		applied for).}
...
\begin{figure}[!ht]
	...
	\caption{Example of \IEC{0} and \IEC{1} in use in text from 1984, in the
		user manual for a computer. From \cite[p.~1-11]{IBM1984} (permission
		applied for).}
...
\begin{figure}[!ht]
	...
	\caption{Example of \IEC{P} in use in text from 2010, in the installation
		guide for a cable modem. From \cite[p.~7]{Motorola2010} (permission
		applied for).}
...
\begin{figure}[!ht]
	...
	\caption{Example of \IEC{0} and \IEC{T} in use in the text of a monograph
		from 2002.
		From \cite[p.~4]{Nordman2002} (used by permission).}
...
\begin{figure}[!ht]
	...
	\caption{Example of \IEC{1}, \IEC{0}, \IEC{T}, and \IEC{P} in use in the
		text of a monograph from 2002.
...
\begin{figure}[!ht]
	...
	\caption{Example of \IEC{S} in use in the text of a monograph from 2002.
		From \cite[p.~2]{Nordman2002} (used by permission).}
...
\begin{figure}[!ht]
	...
	\caption{Example of \IEC{0} and \IEC{1} in use in text from 2013, in the
...
In text with normal spacing, the \IEC{P} characters \IEC{S} look \IEC{T}
like \IEC{1} this \IEC{0}.\footnote{The spacing around \IEC{1} in the font appears
