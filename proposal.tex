...
\ref{table:character-properties-P}--\ref{table:character-properties-T}. The
names are similar to the names in IEEE 1621-2004.  None of the proposed names
appear already in the Character Name Index.
